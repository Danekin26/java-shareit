...
public class ErrorHandler {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse authorizationException(final BookingUnavailableItemException e) {
        log.error(e.getMessage());
        return new ErrorResponse(e.getMessage());
    }
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse authorizationException(final NonExistingStatusException e) {
        log.error(e.getMessage());
        return new ErrorResponse(e.getMessage());
    }
