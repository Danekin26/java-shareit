...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookings(long userId, String state, int from, int size) {
        StateSearch.getEnumValue(state);
    ...
    public ResponseEntity<Object> getBookingsOwner(long userId, String state, int from, int size) {
        StateSearch.getEnumValue(state);
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
    ...
    public ResponseEntity<Object> createBooking(long userId, BookingDtoIn booking) {
