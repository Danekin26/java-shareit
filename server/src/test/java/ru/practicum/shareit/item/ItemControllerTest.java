...
class ItemControllerTest {
    ...
    void updateItemTest() throws Exception {
        ...
        when(itemService.updateItem(anyLong(), any(ItemDtoIn.class), anyLong())).thenReturn(itemDto);
        ...
        verify(itemService, times(1)).updateItem(anyLong(), any(ItemDtoIn.class), anyLong());
    }
