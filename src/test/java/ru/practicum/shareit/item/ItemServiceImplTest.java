...
public class ItemServiceImplTest {
    ...
    void updateItemTest() {
        ...
        ItemDto itemDtoTest = itemService.updateItem(item.getId(), item, user.getId());
    ...
    void updateItemWithNonExistingItemTest() {
        ...
        assertThrows(LackOfRequestedDataException.class, () -> itemService.updateItem(456L, item, idOfUserBeingEdited));
    }
    ...
    void updateItemWithInvalidOwnerTest() {
        ...
        assertThrows(LackOfRequestedDataException.class,
                () -> itemService.updateItem(1L, new Item(), differentUser.getId()));
    }
    ...
    public void updateItemItemNotFoundTest() {
        ...
        assertThrows(LackOfRequestedDataException.class, () ->
                itemService.updateItem(idItem, item, idOfUserBeingEdited));
    ...
    void updateItemWithInvalidItemIdTest() {
        ...
        assertThrows(LackOfRequestedDataException.class, () -> {
            itemService.updateItem(1L, new Item(), 2L);
        });
    }
    ...
    void updateItemWithMismatchedOwnerIdTest() {
        ...
        assertThrows(InvalidDataEnteredException.class, () -> {
            itemService.updateItem(1L, new Item(), 3L);
        });
    }
